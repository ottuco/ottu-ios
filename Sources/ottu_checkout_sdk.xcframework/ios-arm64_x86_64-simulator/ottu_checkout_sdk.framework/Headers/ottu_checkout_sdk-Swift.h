...
#ifndef OTTU_CHECKOUT_SDK_SWIFT_H
#define OTTU_CHECKOUT_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ottu_checkout_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP17ottu_checkout_sdk28FloatingPanelLayoutAnchoring_")
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk33FloatingPanelAdaptiveLayoutAnchor")
...
@interface FloatingPanelAdaptiveLayoutAnchor (SWIFT_EXTENSION(ottu_checkout_sdk))
...
SWIFT_PROTOCOL("_TtP17ottu_checkout_sdk21FloatingPanelBehavior_")
...
SWIFT_PROTOCOL("_TtP17ottu_checkout_sdk19FloatingPanelLayout_")
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk25FloatingPanelBottomLayout")
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk23FloatingPanelController")
...
SWIFT_PROTOCOL("_TtP17ottu_checkout_sdk31FloatingPanelControllerDelegate_")
@protocol FloatingPanelControllerDelegate
@optional
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk34FloatingPanelIntrinsicLayoutAnchor")
...
@interface FloatingPanelIntrinsicLayoutAnchor (SWIFT_EXTENSION(ottu_checkout_sdk))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk25FloatingPanelLayoutAnchor")
...
@interface FloatingPanelLayoutAnchor (SWIFT_EXTENSION(ottu_checkout_sdk))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk33FloatingPanelPanGestureRecognizer")
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk18FloatingPanelState")
...
SWIFT_CLASS("_TtC17ottu_checkout_sdk18GlobalOTPCountdown")
