...
#ifndef OTTU_CHECKOUT_SDK_SENTRY_SWIFT_H
#define OTTU_CHECKOUT_SDK_SENTRY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ottu_checkout_sdk_sentry",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_ENUM_FWD_DECL(NSInteger, FloatingPanelLayoutReferenceGuide)
@class FloatingPanelController;
SWIFT_ENUM_FWD_DECL(NSInteger, FloatingPanelPosition)
@class NSLayoutConstraint;
/// An interface for implementing custom layout anchor objects.
SWIFT_PROTOCOL("_TtP24ottu_checkout_sdk_sentry28FloatingPanelLayoutAnchoring_")
...
@class UILayoutGuide;
SWIFT_ENUM_FWD_DECL(NSInteger, FloatingPanelLayoutContentBoundingGuide)
/// An object that defines how to settles a panel with a layout guide of a content view.
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry33FloatingPanelAdaptiveLayoutAnchor")
...
///
- (nonnull instancetype)initWithAbsoluteOffset:(CGFloat)absoluteOffset contentLayout:(UILayoutGuide * _Nonnull)contentLayout referenceGuide:(enum FloatingPanelLayoutReferenceGuide)referenceGuide contentBoundingGuide:(enum FloatingPanelLayoutContentBoundingGuide)contentBoundingGuide OBJC_DESIGNATED_INITIALIZER;
...
/// \param contentBoundingGuide The rectangular area to restrict the content size of a panel in the main dimension(i.e. y axis is the main dimension for a bottom panel).
///
- (nonnull instancetype)initWithFractionalOffset:(CGFloat)fractionalOffset contentLayout:(UILayoutGuide * _Nonnull)contentLayout referenceGuide:(enum FloatingPanelLayoutReferenceGuide)referenceGuide contentBoundingGuide:(enum FloatingPanelLayoutContentBoundingGuide)contentBoundingGuide OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly) enum FloatingPanelLayoutReferenceGuide referenceGuide;
...
@interface FloatingPanelAdaptiveLayoutAnchor (SWIFT_EXTENSION(ottu_checkout_sdk_sentry))
...
SWIFT_PROTOCOL("_TtP24ottu_checkout_sdk_sentry21FloatingPanelBehavior_")
...
/// proposed state.
/// The default implementation of this method returns <code>false</code>. This method is called for called
...
SWIFT_PROTOCOL("_TtP24ottu_checkout_sdk_sentry19FloatingPanelLayout_")
...
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry25FloatingPanelBottomLayout")
...
SWIFT_ENUM_FWD_DECL(NSInteger, ContentInsetAdjustmentBehavior)
SWIFT_ENUM_FWD_DECL(NSInteger, ContentMode)
@class NSString;
@class NSBundle;
@protocol UIViewControllerTransitionCoordinator;
@class UITraitCollection;
/// A container view controller to display a panel to present contents in parallel as a user wants.
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry23FloatingPanelController")
...
@property (nonatomic, readonly, strong) FloatingPanelSurfaceView * _Nonnull surfaceView;
...
SWIFT_PROTOCOL("_TtP24ottu_checkout_sdk_sentry31FloatingPanelControllerDelegate_")
@protocol FloatingPanelControllerDelegate
@optional
...
/// If <code>attract</code> is true, the panel continues moving towards the nearby state
/// anchor. Otherwise, it stops at the closest state anchor.
/// note:
/// If <code>attract</code> is false, <code>FloatingPanelController.state</code> property has
...
/// Basically, the decision to scroll is based on the <code>state</code> property like the
/// following code.
/// \code
/// func floatingPanel(
...
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry34FloatingPanelIntrinsicLayoutAnchor")
...
///
- (nonnull instancetype)initWithAbsoluteOffset:(CGFloat)absoluteOffset referenceGuide:(enum FloatingPanelLayoutReferenceGuide)referenceGuide OBJC_DESIGNATED_INITIALIZER;
...
/// \param referenceGuide The rectangular area to lay out the content. If it’s set to <code>.safeArea</code>, the panel content lays out inside the safe area of its <code>FloatingPanelController</code>’s view.
///
- (nonnull instancetype)initWithFractionalOffset:(CGFloat)fractionalOffset referenceGuide:(enum FloatingPanelLayoutReferenceGuide)referenceGuide OBJC_DESIGNATED_INITIALIZER;
...
@interface FloatingPanelIntrinsicLayoutAnchor (SWIFT_EXTENSION(ottu_checkout_sdk_sentry))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_ENUM_FWD_DECL(NSInteger, FloatingPanelReferenceEdge)
/// An object that defines how to settles a panel with insets from an edge of a reference rectangle.
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry25FloatingPanelLayoutAnchor")
...
/// positioning.
/// \param absoluteInset An absolute distance to attach the panel from the specified edge.
///
...
/// \param fractionalInset A fractional value of the size of <code>FloatingPanelController</code>’s view to attach the panel from the specified edge.
///
/// \param edge Specify the edge of <code>FloatingPanelController</code>’s view. This is the staring point of the offset.
///
/// \param referenceGuide The rectangular area to lay out the content. If it’s set to <code>.safeArea</code>, the panel content lays out inside the safe area of its <code>FloatingPanelController</code>’s view.
...
@interface FloatingPanelLayoutAnchor (SWIFT_EXTENSION(ottu_checkout_sdk_sentry))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry33FloatingPanelPanGestureRecognizer")
...
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry18FloatingPanelState")
...
SWIFT_CLASS("_TtC24ottu_checkout_sdk_sentry18GlobalOTPCountdown")
@interface GlobalOTPCountdown : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
